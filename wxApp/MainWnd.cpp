...
namespace ftkn
{
  class CustomizedArtProvider : public wxRibbonArtProvider
  {
  public:
    CustomizedArtProvider(bool set_colour_scheme = true);
    virtual ~CustomizedArtProvider();
  ...
  protected:
    ...
    void DrawMinimisedPanelCommon(
      ...
      const wxRect& rect,
      wxRect* preview_rect);
    void CloneTo(CustomizedArtProvider* copy) const;
...
CustomizedArtProvider::CustomizedArtProvider(bool set_colour_scheme)
...
CustomizedArtProvider::~CustomizedArtProvider()
{
}

void CustomizedArtProvider::GetColourScheme(
                         wxColour* primary,
                         wxColour* secondary,
...
void CustomizedArtProvider::SetColourScheme(
...
wxRibbonArtProvider* CustomizedArtProvider::Clone() const
{
    CustomizedArtProvider *copy = new CustomizedArtProvider;
    CloneTo(copy);
    return copy;
}

void CustomizedArtProvider::CloneTo(CustomizedArtProvider* copy) const
{
    int i;
    for(i = 0; i < 4; ++i)
    {
...
long CustomizedArtProvider::GetFlags() const
{
    return m_flags;
}

void CustomizedArtProvider::SetFlags(long flags)
{
...
int CustomizedArtProvider::GetMetric(int id) const
{
    switch(id)
    {
...
void CustomizedArtProvider::SetMetric(int id, int new_val)
{
    switch(id)
    {
        case wxRIBBON_ART_TAB_SEPARATION_SIZE:
...
void CustomizedArtProvider::SetFont(int id, const wxFont& font)
{
    switch(id)
    {
...
wxFont CustomizedArtProvider::GetFont(int id) const
{
    switch(id)
    {
        case wxRIBBON_ART_TAB_LABEL_FONT:
...
wxColour CustomizedArtProvider::GetColour(int id) const
{
    switch(id)
    {
...
void CustomizedArtProvider::SetColour(int id, const wxColor& colour)
{
    switch(id)
    {
        case wxRIBBON_ART_BUTTON_BAR_LABEL_COLOUR:
...
void CustomizedArtProvider::DrawTabCtrlBackground(
                        wxDC& dc,
...
void CustomizedArtProvider::DrawTab(
                 wxDC& dc,
                 wxWindow* WXUNUSED(wnd),
...
void CustomizedArtProvider::DrawTabSeparator(
                        wxDC& dc,
                        wxWindow* wnd,
                        const wxRect& rect,
                        double visibility)
...
void CustomizedArtProvider::ReallyDrawTabSeparator(wxWindow* wnd, const wxRect& rect, double visibility)
{
...
void CustomizedArtProvider::DrawPartialPageBackground(wxDC& dc,
...
void CustomizedArtProvider::DrawPageBackground(
                        wxDC& dc,
                        wxWindow* WXUNUSED(wnd),
                        const wxRect& rect)
{
...
void CustomizedArtProvider::DrawScrollButton(
                        wxDC& dc,
                        wxWindow* WXUNUSED(wnd),
                        const wxRect& rect_,
                        long style)
...
void CustomizedArtProvider::DrawDropdownArrow(wxDC& dc, int x, int y, const wxColour& colour)
{
    wxPoint arrow_points[3];
...
void CustomizedArtProvider::RemovePanelPadding(wxRect* rect)
{
    if(m_flags & wxRIBBON_BAR_FLOW_VERTICAL)
    {
        rect->y += 1;
...
void CustomizedArtProvider::DrawPanelBackground(
                        wxDC& dc,
                        wxRibbonPanel* wnd,
                        const wxRect& rect)
{
...
wxRect CustomizedArtProvider::GetPanelExtButtonArea(wxReadOnlyDC& WXUNUSED(dc),
...
void CustomizedArtProvider::DrawGalleryBackground(
                        wxDC& dc,
                        wxRibbonGallery* wnd,
                        const wxRect& rect)
{
...
void CustomizedArtProvider::DrawGalleryBackgroundCommon(wxDC& dc,
                        wxRibbonGallery* wnd,
                        const wxRect& rect)
{
...
void CustomizedArtProvider::DrawGalleryButton(wxDC& dc,
                                            wxRect rect,
...
void CustomizedArtProvider::DrawGalleryItemBackground(
                        wxDC& dc,
                        wxRibbonGallery* wnd,
                        const wxRect& rect,
...
void CustomizedArtProvider::DrawPanelBorder(wxDC& dc, const wxRect& rect,
...
void CustomizedArtProvider::DrawMinimisedPanel(
                        wxDC& dc,
                        wxRibbonPanel* wnd,
                        const wxRect& rect,
                        wxBitmap& bitmap)
...
void CustomizedArtProvider::DrawMinimisedPanelCommon(
                        wxDC& dc,
                        wxRibbonPanel* wnd,
...
void CustomizedArtProvider::DrawButtonBarBackground(
                        wxDC& dc,
                        wxWindow* wnd,
                        const wxRect& rect)
{
...
void CustomizedArtProvider::DrawPartialPageBackground(
                        wxDC& dc,
                        wxWindow* wnd,
                        const wxRect& rect,
                        bool allow_hovered)
...
void CustomizedArtProvider::DrawButtonBarButton(
                        wxDC& dc,
                        wxWindow* WXUNUSED(wnd),
                        const wxRect& rect,
                        wxRibbonButtonKind kind,
...
void CustomizedArtProvider::DrawButtonBarButtonForeground(
                        wxDC& dc,
                        const wxRect& rect,
                        wxRibbonButtonKind kind,
                        long state,
...
void CustomizedArtProvider::DrawToolBarBackground(
                        wxDC& dc,
                        wxWindow* wnd,
                        const wxRect& rect)
{
...
void CustomizedArtProvider::DrawToolGroupBackground(
                        wxDC& dc,
                        wxWindow* WXUNUSED(wnd),
                        const wxRect& rect)
{
...
void CustomizedArtProvider::DrawTool(
                wxDC& dc,
                wxWindow* WXUNUSED(wnd),
                const wxRect& rect,
                const wxBitmap& bitmap,
...
void
CustomizedArtProvider::DrawToggleButton(wxDC& dc,
                                         wxRibbonBar* wnd,
                                         const wxRect& rect,
...
void CustomizedArtProvider::DrawHelpButton(wxDC& dc,
                                       wxRibbonBar* wnd,
                                       const wxRect& rect)
{
    DrawPartialPageBackground(dc, wnd, rect, false);
...
void CustomizedArtProvider::GetBarTabWidth(
                        wxReadOnlyDC& dc,
                        wxWindow* WXUNUSED(wnd),
                        const wxString& label,
                        const wxBitmap& bitmap,
...
int CustomizedArtProvider::GetTabCtrlHeight(
                        wxReadOnlyDC& dc,
                        wxWindow* WXUNUSED(wnd),
...
wxSize CustomizedArtProvider::GetScrollButtonMinimumSize(
...
wxSize CustomizedArtProvider::GetPanelSize(
                        wxReadOnlyDC& dc,
                        const wxRibbonPanel* wnd,
                        wxSize client_size,
                        wxPoint* client_offset)
...
wxSize CustomizedArtProvider::GetPanelClientSize(
                        wxReadOnlyDC& dc,
                        const wxRibbonPanel* wnd,
                        wxSize size,
                        wxPoint* client_offset)
...
wxSize CustomizedArtProvider::GetGallerySize(
                        wxReadOnlyDC& WXUNUSED(dc),
...
wxSize CustomizedArtProvider::GetGalleryClientSize(
                        wxReadOnlyDC& WXUNUSED(dc),
                        const wxRibbonGallery* WXUNUSED(wnd),
                        wxSize size,
                        wxPoint* client_offset,
...
wxRect CustomizedArtProvider::GetPageBackgroundRedrawArea(
                        wxReadOnlyDC& WXUNUSED(dc),
...
bool CustomizedArtProvider::GetButtonBarButtonSize(
                        wxReadOnlyDC& dc,
                        wxWindow* wnd,
                        wxRibbonButtonKind kind,
                        wxRibbonButtonBarButtonState size,
...
wxCoord CustomizedArtProvider::GetButtonBarButtonTextWidth(
                        wxReadOnlyDC& dc, const wxString& label,
                        wxRibbonButtonKind kind,
                        wxRibbonButtonBarButtonState size)
{
...
wxSize CustomizedArtProvider::GetMinimisedPanelMinimumSize(
                        wxReadOnlyDC& dc,
                        const wxRibbonPanel* wnd,
                        wxSize* desired_bitmap_size,
...
wxSize CustomizedArtProvider::GetToolSize(
                        wxReadOnlyDC& WXUNUSED(dc),
                        wxWindow* WXUNUSED(wnd),
                        wxSize bitmap_size,
                        wxRibbonButtonKind kind,
...
wxRect
CustomizedArtProvider::GetBarToggleButtonArea(const wxRect& rect)
{
...
wxRect
CustomizedArtProvider::GetRibbonHelpButtonArea(const wxRect& rect)
{
  ...
  class CustomizedArtProvider_ : public CustomizedArtProvider
	{
	public:
		using CustomizedArtProvider::CustomizedArtProvider;
		void DrawTabCtrlBackground(
			wxDC& dc,
			wxWindow* WXUNUSED(wnd),
			const wxRect& rect)
...
namespace ftkn
{
	template<typename BaseFrame, long DefaultStyle = wxDEFAULT_FRAME_STYLE>
    ...
    MainFrame(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = DefaultStyle, const wxString& name = wxASCII_STR(wxFrameNameStr))
    {
      Create(parent, id, title, pos, size, style, name);
    }

    bool Create(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = DefaultStyle, const wxString& name = wxASCII_STR(wxFrameNameStr))
    {
    ...
    void CreateRibbon()
    {
      auto ribbon = new wxRibbonBar(this, -1, wxDefaultPosition, wxDefaultSize, wxRIBBON_BAR_FLOW_HORIZONTAL
        | wxRIBBON_BAR_SHOW_PAGE_LABELS
        | wxRIBBON_BAR_SHOW_PANEL_EXT_BUTTONS
        | wxRIBBON_BAR_SHOW_TOGGLE_BUTTON
        | wxRIBBON_BAR_SHOW_HELP_BUTTON
      );
      wxRibbonPage* home = new wxRibbonPage(ribbon, wxID_ANY, wxT("Home"));// , ribbon_xpm);

    	wxRibbonPage* view = new wxRibbonPage(ribbon, wxID_ANY, wxT("View"));// , ribbon_xpm);

    	wxRibbonPage* operations = new wxRibbonPage(ribbon, wxID_ANY, wxT("Operations"));// , ribbon_xpm);
    	...
    	wxRibbonToolBar* toolbar = new wxRibbonToolBar(toolbar_panel, 1000);// ID_MAIN_TOOLBAR);
			ribbon->SetArtProvider(new CustomizedArtProvider);
      ribbon->Realize();
    }
      ...
      BaseFrame::SetMenuBar(menuBar);
		...
		void CreateStatus()
		{
			if (auto statusBar = BaseFrame::CreateStatusBar(1, wxSTB_DEFAULT_STYLE, ID_STATUSBAR))
			{
				...
				m_Gauge = new wxGauge(BaseFrame::m_frameStatusBar, -1, 100, pr.GetPosition(), pr.GetSize(), wxGA_SMOOTH | wxGA_PROGRESS);
		...
		{
			auto toolBar = new wxToolBar(this, ID_STANDARD_TOOLBAR);
		...
		{
			auto toolBar = new wxToolBar(this, ID_ADDITIONAL_TOOLBAR);
...
namespace ftk
{
    ...
    const wxSize& size, long style, const wxString& name)
  {
    ...
    auto frame = new ftkn::MainFrame<wxFrame>(parent, id, "FTK Demo App", pos, sz, style, name);
    return frame;
  }
}
