...
# rentrant variables
#
MACRO(LHPExternalLibraries_SUBPROJECT SUBPROJECT_NAME SUBPROJECT_DIR)

  # if not previous configure errors
  IF (NOT CONFIGURE_ERROR)  
    IF (EXISTS ${LHPExternalLibraries_SOURCE_DIR}/${SUBPROJECT_DIR}/Configure.cmake)
      MESSAGE (STATUS "Configuring subproject ${SUBPROJECT_NAME}")
      # Set some useful variables
      SET(SUBPROJECT_BINARY_DIR ${LHPExternalLibraries_BINARY_DIR}/${SUBPROJECT_DIR})
      SET (${SUBPROJECT_NAME}_BINARY_DIR ${LHPExternalLibraries_BINARY_DIR}/${SUBPROJECT_DIR})
      SET(SUBPROJECT_SOURCE_DIR ${LHPExternalLibraries_SOURCE_DIR}/${SUBPROJECT_DIR})
      SET (${SUBPROJECT_NAME}_SOURCE_DIR ${LHPExternalLibraries_SOURCE_DIR}/${SUBPROJECT_DIR})
    ...
    ENDIF (EXISTS ${LHPExternalLibraries_SOURCE_DIR}/${SUBPROJECT_DIR}/Configure.cmake)
  ELSE (NOT CONFIGURE_ERROR)
    MESSAGE ("Not configuring ${SUBPROJECT_NAME} due to previuos errors")
  ENDIF (NOT CONFIGURE_ERROR)
ENDMACRO(LHPExternalLibraries_SUBPROJECT)