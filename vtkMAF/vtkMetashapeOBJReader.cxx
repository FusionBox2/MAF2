...
vtkStandardNewMacro(vtkMetashapeOBJReader);

//------------------------------------------------------------------------------
vtkMetashapeOBJReader::vtkMetashapeOBJReader()
{
...
//------------------------------------------------------------------------------
vtkSmartPointer<vtkResourceStream> vtkMetashapeOBJReader::Open()
{
  if (this->Stream)
  {
...
int vtkMetashapeOBJReader::RequestData(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkMetashapeOBJReader::PrintSelf(ostream& os, vtkIndent indent)
{
