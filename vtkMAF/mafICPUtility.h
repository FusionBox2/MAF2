...
//-----------------------------------------------------------------
	...
	int ind=0; //Necessario se, fuori dal for, voglio capire qual'� stata l'ultima RAR applicata
...
//----------------------------------------------------------------------------
{
	...
	DS_temp.inplace_transpose(); //adesso DS_temp � 3xn
