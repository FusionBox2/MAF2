...
#define VTK_DENSITY_MODE  2
  ...
  protected:
    ...
    void PrepareVolume(vtkDataSet* sourceDataset);
    ...
    template<typename DataType> double FindDensity(vtkDataSet* sourceDataset, const double point[3], const DataType *dataPointer);
