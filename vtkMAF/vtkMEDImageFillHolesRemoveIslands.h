...
*/
//---------------------------------------------------------------------------
class VTK_vtkMAF_EXPORT vtkMEDImageFillHolesRemoveIslands : public vtkStructuredGridAlgorithm
//---------------------------------------------------------------------------
{
public:
  ...
  vtkTypeMacro(vtkMEDImageFillHolesRemoveIslands, vtkStructuredGridAlgorithm);
