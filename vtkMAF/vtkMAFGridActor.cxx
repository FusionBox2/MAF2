...
//------------------------------------------------------------------------------
vtkMAFGridActor::~vtkMAFGridActor() = default;
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
int vtkMAFGridActor::RenderOpaqueGeometry(vtkViewport* viewport)
//------------------------------------------------------------------------------
{
	...
	Grid->RenderOpaqueGeometry(viewport);
	Axis1->RenderOpaqueGeometry(viewport);
	Axis2->RenderOpaqueGeometry(viewport);

	return 1;
}
//------------------------------------------------------------------------------
int vtkMAFGridActor::RenderTranslucentPolygonalGeometry(vtkViewport* viewport)
//------------------------------------------------------------------------------
{
	return 0;
}
...
//------------------------------------------------------------------------------
void vtkMAFGridActor::AdjustClippingRange(vtkViewport* viewport)
//------------------------------------------------------------------------------
{
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
{
	...
	vtkSmartPointer<vtkPoints> gp = vtkNew<vtkPoints>();
	gp->SetNumberOfPoints(np);

	vtkSmartPointer<vtkCellArray> gc = vtkNew<vtkCellArray>();
	...
	vtkSmartPointer<vtkPolyData> g_grid = vtkNew<vtkPolyData>();
	g_grid->SetPoints(gp);
	g_grid->SetLines(gc);

	vtkNew<vtkPolyDataMapper> g_pdm = vtkNew<vtkPolyDataMapper>();
	//g_pdm->ImmediateModeRenderingOn();
	g_pdm->SetInputData(g_grid);

	vtkSmartPointer<vtkProperty> g_p = vtkNew<vtkProperty>();
	...
	// Axis Property///////////////////
	vtkSmartPointer<vtkProperty> a_p = vtkNew<vtkProperty>();
	...
	// Axis1 //////////////////////////
	vtkSmartPointer<vtkLineSource> a1 = vtkNew<vtkLineSource>();
	a1->SetPoint1(0, 0, 0);
	a1->SetPoint2(GridSize, 0, 0);
	vtkSmartPointer<vtkPolyDataMapper> a1_pdm = vtkNew<vtkPolyDataMapper>();
	...
	// Axis2 //////////////////////////
	vtkSmartPointer<vtkLineSource> a2 = vtkNew<vtkLineSource>();
	a2->SetPoint1(0, 0, 0);
	a2->SetPoint2(0, GridSize, 0);
	vtkSmartPointer<vtkPolyDataMapper> a2_pdm = vtkNew<vtkPolyDataMapper>();
...
vtkTextActor* vtkMAFGridActor::GetLabelActor()
{
	return Label;
}
