...
//----------------------------------------------------------------------------
class VTK_vtkMAF_EXPORT vtkMEDVolumeSlicerNotInterpolated : public vtkDataSetAlgorithm
//----------------------------------------------------------------------------
{
public:
  ...
  /** RTTI Macro */
  vtkTypeMacro(vtkMEDVolumeSlicerNotInterpolated, vtkDataSetAlgorithm);
