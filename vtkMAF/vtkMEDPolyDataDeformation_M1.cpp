...
/*virtual*/ vtkMTimeType vtkMEDPolyDataDeformation_M1::GetMTime()
//------------------------------------------------------------------------
{
...
/*virtual*/int vtkMEDPolyDataDeformation_M1::RequestInformation(
  ...
  vtkInformationVector *outputVector)
{
 ...
 /* {
  ...
  cellLocator->SetDataSet(this->GetPolyDataInput(0));
  cellLocator->Update();
