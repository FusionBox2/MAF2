...
class vtkMAFXYPlotActorConnections: public vtkAlgorithm
{
public:
  static vtkMAFXYPlotActorConnections *New();
  vtkTypeMacro(vtkMAFXYPlotActorConnections,vtkAlgorithm);

  vtkMAFXYPlotActorConnections()
  {
    this->SetNumberOfInputPorts( 1 );
  }
};

vtkStandardNewMacro(vtkMAFXYPlotActorConnections);
...
vtkMAFXYPlotActor::vtkMAFXYPlotActor()
{
  ...
  this->InputConnectionHolder = vtkMAFXYPlotActorConnections::New();
  this->SelectedInputScalars = NULL;
  this->SelectedInputScalarsComponent = vtkIntArray::New();

  this->DataObjectInputConnectionHolder = vtkMAFXYPlotActorConnections::New();
  ...
  this->AdjustTitlePositionMode =
    vtkMAFXYPlotActor::AlignHCenter
    | vtkMAFXYPlotActor::AlignTop
    | vtkMAFXYPlotActor::AlignAxisHCenter
    | vtkMAFXYPlotActor::AlignAxisVCenter;
}
...
//----------------------------------------------------------------------------
bool vtkMAFXYPlotActor::DoesConnectionMatch( int i, vtkAlgorithmOutput* in )
{
...
//----------------------------------------------------------------------------
int vtkMAFXYPlotActor::IsInputPresent( vtkAlgorithmOutput* in,
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::AddDataSetInput( vtkDataSet *ds,
                                      const char *arrayName,
                                      int component )
{
...
void vtkMAFXYPlotActor::AddDataSetInputConnection( vtkAlgorithmOutput *in,
                                                const char *arrayName,
                                                int component )
{
  int idx, num;
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::RemoveAllDataSetInputConnections()
{
  int idx, num;
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::RemoveDataSetInput( vtkDataSet *ds,
                                         const char *arrayName,
                                         int component )
{
  int numConns = this->InputConnectionHolder->GetNumberOfInputConnections( 0 );
...
void vtkMAFXYPlotActor::RemoveDataSetInputConnection( vtkAlgorithmOutput *in,
                                                   const char *arrayName,
                                                   int component )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::AddDataObjectInputConnection( vtkAlgorithmOutput *aout )
{
...
void vtkMAFXYPlotActor::RemoveDataObjectInputConnection( vtkAlgorithmOutput *aout )
{
  int numDO =
    this->DataObjectInputConnectionHolder->GetNumberOfInputConnections( 0 );
  for ( int i=0 ; i<numDO; i++)
...
int vtkMAFXYPlotActor::HasTranslucentPolygonalGeometry()
{
  return 0;
}
...
//----------------------------------------------------------------------------
double *vtkMAFXYPlotActor::TransformPoint( int pos[2], int pos2[2],
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetYTitle( const char* ytitle )
{
...
//----------------------------------------------------------------------------
char* vtkMAFXYPlotActor::GetYTitle()
{
  return this->YTitleActor->GetInput();
}

//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetXTitlePosition( double position )
{
...
//----------------------------------------------------------------------------
double vtkMAFXYPlotActor::GetXTitlePosition()
{
  return this->XAxis->GetTitlePosition();
}

//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAdjustXLabels( int adjust )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAdjustYLabels( int adjust )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetXLabelFormat( const char* _arg )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetYLabelFormat( const char* _arg )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetNumberOfXMinorTicks( int num )
{
...
//----------------------------------------------------------------------------
int vtkMAFXYPlotActor::GetNumberOfXMinorTicks()
{
  return this->XAxis->GetNumberOfMinorTicks();
}

//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetNumberOfYMinorTicks( int num )
{
...
//----------------------------------------------------------------------------
int vtkMAFXYPlotActor::GetNumberOfYMinorTicks()
{
  return this->YAxis->GetNumberOfMinorTicks();
}

//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::PrintAsCSV( ostream &os )
{
  vtkDataArray *scalars;
  vtkDataSet *ds;
  double s;
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::AddUserCurvesPoint( double c_dbl, double x, double y )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::RemoveAllActiveCurves()
{
...
//  \li 24 : 11 + fillOff
//  \li 25 : 12 + fillOff*
void vtkMAFXYPlotActor::SetPlotGlyphType( int curve, int i )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetXAxisColor( double r, double g, double b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetYAxisColor( double r, double g, double b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetLegendBorder( int b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetLegendBox( int b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetLegendUseBackground( int b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetLegendBackgroundColor( double r, double g, double b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetLineWidth( double w )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleColor( double r, double g, double b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleFontFamily( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleBold( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleItalic( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleShadow( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleFontSize( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleJustification( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetTitleVerticalJustification( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleColor( double r, double g, double b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleFontFamily( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleBold( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleItalic( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleShadow( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleFontSize( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleJustification( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleVerticalJustification( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisTitleTextProperty( vtkTextProperty* p )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelColor( double r, double g, double b )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelFontFamily( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelBold( int x )
{
  this->GetAxisLabelTextProperty()->SetBold( x );
}

//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelItalic( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelShadow( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelFontSize( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelJustification( int x )
{
...
//----------------------------------------------------------------------------
void vtkMAFXYPlotActor::SetAxisLabelVerticalJustification( int x )
{
