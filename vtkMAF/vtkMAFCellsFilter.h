...
*/ 
class VTK_vtkMAF_EXPORT vtkMAFCellsFilter : public vtkPolyDataAlgorithm
{
...
private:
  ...
  vtkMAFCellsFilter(const vtkMAFCellsFilter&) = delete;
  /** operator =, not implemented */
  void operator=(const vtkMAFCellsFilter&) = delete;
};
