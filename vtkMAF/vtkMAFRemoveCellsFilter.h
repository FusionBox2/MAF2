...
public:
 ...
 int GetNumberOfDeletedCells() { return 0; }// this->GetInput()->GetNumberOfCells() - this->GetOutput()->GetNumberOfCells(); }
 int GetNumberOfRemovedCells() { return 0; }// this->GetInput()->GetNumberOfCells() - this->GetOutput()->GetNumberOfCells(); }
