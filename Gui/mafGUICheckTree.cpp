...
namespace gui::wx
{
    ...
    //----------------------------------------------------------------------------
    void CheckTree::OnMouseEvent(wxMouseEvent& event)
        //----------------------------------------------------------------------------
    {
    ...
    void CheckTree::VmeAdd(std::shared_ptr<mafNode> vme)
        //----------------------------------------------------------------------------
    {
        AddNode((intptr_t)vme.get(), (intptr_t)vme->GetParent(), vme->GetName().toWx(), 0, new CheckTreeItemData((intptr_t)vme.get(), vme));
    ...
    void CheckTree::VmeModified(mafNode* vme)
        //----------------------------------------------------------------------------
    {
        this->SetNodeLabel((intptr_t)vme, vme->GetName().toWx());
        VmeUpdateIcon(vme);
