...
medGUILutHistogramEditor::medGUILutHistogramEditor(vtkDataSet *dataSet,std::shared_ptr<mmaVolumeMaterial> material, const char *name, mafBaseEventHandler *Listener, int id)
...
//----------------------------------------------------------------------------
void medGUILutHistogramEditor::ShowLutHistogramDialog(vtkDataSet *dataSet,std::shared_ptr<mmaVolumeMaterial> material,const char *name, mafBaseEventHandler *listener, int id)
//----------------------------------------------------------------------------
{
