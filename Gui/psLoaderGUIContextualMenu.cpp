/*=========================================================================
  ...
  Module:    $RCSfile: psLoaderGUIContextualMenu.cpp,v $
  Language:  C++
...
// Event Table:
//----------------------------------------------------------------------------
BEGIN_EVENT_TABLE(psLoaderGUIContextualMenu,wxMenu)
  EVT_MENU_RANGE(CONTEXTUAL_VIEW_MENU_START, CONTEXTUAL_VIEW_MENU_STOP, psLoaderGUIContextualMenu::OnContextualViewMenu)
END_EVENT_TABLE()
...
//----------------------------------------------------------------------------
void psLoaderGUIContextualMenu::ShowContextualMenu(wxFrame *child, mafView *view, bool vme_menu)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void psLoaderGUIContextualMenu::OnContextualViewMenu(wxCommandEvent& event)
//----------------------------------------------------------------------------
{
	switch(event.GetId())
	{
