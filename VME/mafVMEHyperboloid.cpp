...
//-------------------------------------------------------------------------
{
	...
	{
		auto hyperboloid = mafVMEHyperboloid::StaticDownCast(vme);
		if (
...
std::shared_ptr<mmaMaterial> mafVMEHyperboloid::GetMaterial()
//-------------------------------------------------------------------------
{
...
void mafVMEHyperboloid::SetCenterLink(const mafString& link_name, mafNode* n)
//-------------------------------------------------------------------------
{
...
vtkAlgorithm* mafVMEHyperboloid::plotFunction(vtkQuadric* quadric, double value)
{
