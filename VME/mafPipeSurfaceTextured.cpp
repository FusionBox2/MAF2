...
//----------------------------------------------------------------------------
{
  ...
  m_Gui->Button(ID_CHOOSE_TEXTURE, &m_VmeImageName,_("Select the texture image"),_("texture"));
 ...
 /* wxPoint p; p.x = 00; p.y = 235;
  ...
  m_progressGauge->SetName("progress bar");
  m_progressGauge->SetPosition(p);*/
 
  //m_progressGauge->Show(false);
  m_Gui->Divider();
