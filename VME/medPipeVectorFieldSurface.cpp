...
//----------------------------------------------------------------------------
{
	...
	else
	{
		if (nVectors > 1)
		{
			...
			wxComboBox* comboField = new wxComboBox(gui, ID_VECTORFIELD, wxEmptyString,
		...
		bSizer2->Add(new wxStaticText(gui, wxID_ANY, _("Color by:"),
			wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		wxComboBox* comboColorBy = new wxComboBox(gui, ID_COLOR_MAPPING_MODE,
		...
		mafGUILutSwatch* luts2 = new mafGUILutSwatch(gui, ID_COLOR_MAPPING_LUT,
		...
		wxCheckBox* chckShowSFLegend1 = new wxCheckBox(gui, ID_SHOW_COLOR_MAPPING,
