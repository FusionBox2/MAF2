...
//----------------------------------------------------------------------------
{
	...
	if (nVectors == 0)  //no vector field available, this pipe does not work
		bSizerMain->Add(new wxStaticText(gui, wxID_ANY, _("No vector field to visualize.")));
	else
	{
		if (nVectors > 1)
		{
			wxBoxSizer* bSizer1 = new wxBoxSizer(wxHORIZONTAL);
			bSizer1->Add(new wxStaticText(gui, wxID_ANY, _("Vector Field:"),
				wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

			wxComboBox* comboField = new wxComboBox(gui, ID_VECTORFIELD,
		...
		if (nScalars > 1)
		{
			...
			bSizer51111->Add(new wxStaticText(gui, wxID_ANY, _("Scalar Field:"),
				wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

			wxComboBox* comboScalars = new wxComboBox(gui, ID_SCALARFIELD,
				wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
		...
		bSizer52->Add(new wxStaticText(gui, wxID_ANY, _("Glyph Type:"),
			wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		wxComboBox* comboGlyphs = new wxComboBox(gui, ID_GLYPH_TYPE,
			wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
...
//----------------------first filter list----------
		wxStaticBoxSizer* sbSizer3 = new wxStaticBoxSizer(
			new wxStaticBox(gui, wxID_ANY, wxT("Range")), wxVERTICAL);
		m_RangeCtrl = new wxListCtrl(gui, ID_LIST_RANGES, wxDefaultPosition,
		...
		sbSizer3->Add(new wxStaticText(gui, wxID_ANY, _("magnitude value:"),
			wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);
		sbSizer3->Add(m_RangeCtrl, 1, wxALL | wxEXPAND, 1);
		//buttons----------------------------------
		wxBoxSizer* bSizer6 = new wxBoxSizer(wxHORIZONTAL);
		bSizer6->Add(new wxPanel(gui, wxID_ANY, wxDefaultPosition,
			wxDefaultSize, wxTAB_TRAVERSAL), 1, wxALL, 5);

		m_BttnAddItem = new wxButton(gui, ID_ADDITEM, wxT("Add"),
		...
		m_BttnRemoveItem = new wxButton(gui, ID_REMOVEITEM, wxT("Remove"),
			wxDefaultPosition, wxSize(50, -1), 0);
		...
		m_BttnShow = new wxButton(gui, ID_SHOWITEM, wxT("Show"),
			wxDefaultPosition, wxSize(50, -1), 0);
		...
		{
			//second filter list--------------------------------
			m_RangeCtrl2 = new wxListCtrl(gui, ID_LIST_RANGES, wxDefaultPosition,
				wxDefaultSize, wxLC_NO_SORT_HEADER | wxLC_REPORT | wxLC_SINGLE_SEL);
			m_RangeCtrl2->SetColumnWidth(0, 200);//wxLIST_AUTOSIZE_USEHEADER
			m_RangeCtrl2->SetColumnWidth(1, 300);// useless

			sbSizer3->Add(new wxStaticText(gui, wxID_ANY, _("scalar Filter:"),
				wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);
			sbSizer3->Add(m_RangeCtrl2, 1, wxALL | wxEXPAND, 1);
			//buttons--------------------------------
			wxBoxSizer* bSizer7 = new wxBoxSizer(wxHORIZONTAL);
			bSizer7->Add(new wxPanel(gui, wxID_ANY, wxDefaultPosition,
				wxDefaultSize, wxTAB_TRAVERSAL), 1, wxALL, 5);

			m_BttnAddItem2 = new wxButton(gui, ID_ADDITEM2, wxT("Add"),
				wxDefaultPosition, wxSize(50, -1), 0);
			...
			m_BttnRemoveItem2 = new wxButton(gui, ID_REMOVEITEM2, wxT("Remove"),
				wxDefaultPosition, wxSize(50, -1), 0);
			...
			m_BttnShow2 = new wxButton(gui, ID_SHOWITEM2, wxT("Show"),
				wxDefaultPosition, wxSize(50, -1), 0);
			...
			bSizer8->Add(new wxPanel(gui, wxID_ANY, wxDefaultPosition,
				wxDefaultSize, wxTAB_TRAVERSAL), 1, wxALL, 5);
			...
			wxRadioBox* radioBox = new wxRadioBox(gui, ID_CHOOSE_ANDOR, "interaction logic", wxDefaultPosition, wxSize(120, 40), radioStrings, 1, wxRA_SPECIFY_ROWS);//wxEmptyString
			radioBox->SetValidator(mafGUIValidator(this, ID_CHOOSE_ANDOR, radioBox, &m_AndOr));

			m_BttnShowAssociate = new wxButton(gui, ID_SHOWITEM, wxT("Show"),
				wxDefaultPosition, wxSize(50, -1), 0);
		...
		*/
		wxCheckBox* chckShowAll = new wxCheckBox(gui,
...
#pragma region Glyph shape
		wxStaticBoxSizer* sbSizer2 = new wxStaticBoxSizer(
			new wxStaticBox(gui, wxID_ANY, _("Glyph shape")), wxVERTICAL);
		wxBoxSizer* bSizer5 = new wxBoxSizer(wxHORIZONTAL);
		bSizer5->Add(new wxStaticText(gui, wxID_ANY, _("Radius:"),
			wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		wxTextCtrl* edRadius = new wxTextCtrl(gui, ID_GLYPH_RADIUS);
		...
		bSizer5->Add(new wxStaticText(gui, wxID_ANY, _("Res:"),
			wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT), 1, wxALL, 5);

		wxTextCtrl* edRes = new wxTextCtrl(gui, ID_GLYPH_RESOLUTION);
		...
		bSizer51->Add(new wxStaticText(gui, wxID_ANY, _("Length:"),
			wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		wxTextCtrl* edLength = new wxTextCtrl(gui, ID_GLYPH_LENGTH);
		...
		bSizer51->Add(new wxStaticText(gui, wxID_ANY, _("Scaling:"),
			wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT), 1, wxALL, 5);

		wxComboBox* comboScale = new wxComboBox(gui, ID_GLYPH_SCALING,
			wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
...
#pragma region Glyph Colors
		wxStaticBoxSizer* sbSizer65 = new wxStaticBoxSizer(
			new wxStaticBox(gui, wxID_ANY, _("Glyph Color")), wxVERTICAL);

		wxBoxSizer* bSizer4311 = new wxBoxSizer(wxHORIZONTAL);
		bSizer4311->Add(new wxStaticText(gui, wxID_ANY, _("Material:"),
			wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		m_GlyphMaterialButton = new mafGUIPicButton(gui,
		...
		wxCheckBox* chckShowScalarField1 = new wxCheckBox(gui,
		...
		wxStaticBoxSizer* sbSizer221 = new wxStaticBoxSizer(
			new wxStaticBox(gui, wxID_ANY, wxEmptyString), wxVERTICAL);

		//scalar field widgets
		if (nScalars > 0)
		{
			wxCheckBox* checkBox52 = new wxCheckBox(gui, ID_USE_SF_MAPPING,
		...
		bSizer432->Add(new wxStaticText(gui, wxID_ANY, _("LUT:")), 0, wxALL, 5);

		mafGUILutSwatch* luts2 = new mafGUILutSwatch(gui, ID_SF_MAPPING_LUT,
		...
		wxCheckBox* chckShowSFLegend1 = new wxCheckBox(gui, ID_SHOW_SF_MAPPING,
...
//----------------------------------------------------------------------------
{
	...
	int idx1 = 0, idx2 = 0;
	for (auto& link : m_Vme->GetLinks())
	{
		mafString linkName = link.first;
...
//-----------------------------------------------------------------------
{
	...
	do
	{
		...
		for (auto& link : m_Vme->GetLinks())
		{
			if (link.first.starts_with(_R(FILTER_LINK_NAME)))
			{
				m_Vme->RemoveLink(link.first);
				bNeedRestart = true;
				break;
			}
		}
...
//-----------------------------------------------------------------------
{
	...
	do
	{
		...
		for (auto& link : m_Vme->GetLinks())
		{
			if (link.first.starts_with(_R(FILTER_LINK_NAME2)))
			{
				m_Vme->RemoveLink(link.first);
				bNeedRestart = true;
				break;
