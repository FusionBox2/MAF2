...
const mafString& lhpPipeIntGraphFixed::GetVarTitle(int i) const
{
	return emptyDesc;
}

const mafString& lhpPipeIntGraphFixed::GetVarUnit(int i)const
{
	return emptyDesc;
}
...
//----------------------------------------------------------------------------
{
	...
	m_CheckBoxXval = gui->CheckList(ID_CHECK_BOXXVAL, _L("X value"), 100, _L("Choose value for X axis"));
	m_CheckBoxYval = gui->CheckList(ID_CHECK_BOXYVAL, _L("Y values"), 100, _L("Choose values for Y axis"));
	m_CheckBoxYder = gui->CheckList(ID_CHECK_BOXYDER, _L("Y derivs"), 100, _L("Choose values for Y axis"));
