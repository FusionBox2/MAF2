  ...
  do
  {
    ...
    {	
      if(sscanf(buf,"%f %f %f %f %f %f",&R_x,&R_y,&R_z,&X,&Y,&Z) == 6)
      {
        ...
        // Il time stamp cos� calcolato � sempre 0!!! passando una mflMatrix a AppendKeyMatrix il
        // suo time stamp � conservato, anche per questo i PGD non si muovevano!!!
        // Passandolgi una matrice vtkMatrix4x4 il time stamp � calcolato automaticamente in modo 
        // progresivo, per cui il PGD si muove ma il tempo non � quello estratto dal file PGD
