...
//----------------------------------------------------------------------------
{
	...
	vtkNew<vtkColorTransferFunction> table;
...
//----------------------------------------------------------------------------
{
	...
	gui->Button(ID_SELECT_SURFACE, _L("Select Surface:"), _R(""), _L("Select a surface to compute collisions"));
	gui->Button(ID_ADD_SURFACE, _L("Add Surface:"), _R(""), _L("Add a surface to compute collisions"));
	return gui;
}
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
{
	...
	{
		vtkNew<vtkDoubleArray> contactScalars0;
		...
		for (int i = 0; i < m_SurfacesToCollide.size(); i++)
		{
			...
			if (m_ShowSurfaceToCollide)
			{
				...
				tpd->Update();
				vtkNew<vtkDoubleArray> contactScalars1;
