...
//----------------------------------------------------------------------------
{
	...
	bSizerMain->Add(new wxStaticLine(gui, wxID_ANY, wxDefaultPosition,
		wxDefaultSize, wxLI_HORIZONTAL), 0, wxEXPAND | wxALL, 5);

	wxBoxSizer* bSizer1 = new wxBoxSizer(wxHORIZONTAL);
	bSizer1->Add(new wxStaticText(gui, wxID_ANY, _("Slice Dir.:"),
		wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

	wxComboBox* comboSliceDir = new wxComboBox(gui, ID_SLICE_DIRECTION,
	...
	bSizer2->Add(new wxStaticText(gui, wxID_ANY, _("Slice Pos.:"),
		wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

	m_SliderSlice = new mafGUIFloatSlider(gui, ID_SLICE_POS_SLIDER, m_SlicePos);
	bSizer2->Add(m_SliderSlice, 1, wxALL, 0);

	m_TextSlice = new wxTextCtrl(gui, ID_SLICE_POS, wxEmptyString,
