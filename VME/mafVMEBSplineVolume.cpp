...
//-------------------------------------------------------------------------
{
	...
	gui->Integer(ID_ORDERZ, _L("Order Z"), &m_OrderZ, 1, 10);
	gui->Combo(ID_MODE, _L("Mode"), &m_Mode, DIM(mode_choices_string), mode_choices_string);

	gui->Integer(ID_NUMSOURCEX, _L("Num source X"), &m_SourceX, 5, 500);
	gui->Integer(ID_NUMSOURCEY, _L("Num source Y"), &m_SourceY, 5, 500);
	gui->Integer(ID_NUMSOURCEZ, _L("Num source Y"), &m_SourceZ, 5, 500);

	gui->Integer(ID_NUMTESSELX, _L("Num parts X"), &m_TesselX, 2, 500);
	gui->Integer(ID_NUMTESSELY, _L("Num parts Y"), &m_TesselY, 2, 500);
	gui->Integer(ID_NUMTESSELZ, _L("Num parts Y"), &m_TesselZ, 2, 500);
