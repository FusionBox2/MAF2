...
#ifndef __mafPipeMuscleWrapperAQ_H__
#define __mafPipeMuscleWrapperAQ_H__
...
//----------------------------------------------------------------------------
// mafPipeMuscleWrapper :
//----------------------------------------------------------------------------
class MAF_EXPORT mafPipeMuscleWrapperAQ : public mafPipeVTK
{
public:
...
protected:
  mafVMEMuscleWrapperAQ       *m_MuscleWrapperVME;
