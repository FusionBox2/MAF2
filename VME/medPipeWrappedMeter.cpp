...
//----------------------------------------------------------------------------
void medPipeWrappedMeter::Create(mafNode* node, mafView* view/*, bool use_axes*/)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
{
	...
	gui->Enable(ID_DISTANCE_RANGE, meter_attrib->m_ColorMode == medVMEWrappedMeter::RANGE_COLOR);
	gui->Enable(ID_TUBE_RADIUS, meter_attrib->m_Representation == medVMEWrappedMeter::TUBE_REPRESENTATION);
	gui->Enable(ID_TUBE_CAPPING, meter_attrib->m_Representation == medVMEWrappedMeter::TUBE_REPRESENTATION);
	gui->Divider();
