...
//----------------------------------------------------------------------------
{
	...
	{
		gui->Label(_R("No vector or scalar fields to visualize."), false);
		return gui;
	}
	...
	if (nScalars > 0)
	{
		wxStaticBoxSizer* bSizerScalar = new wxStaticBoxSizer(new wxStaticBox(gui, wxID_ANY, wxT("Scalar fields")), wxVERTICAL);

		wxCheckBox* ckScalars = new wxCheckBox(gui, ID_ACTIVATE_SCALARS, _("Activate scalar fields"), wxDefaultPosition, wxDefaultSize, 0);
		...
		bSizer_s1->Add(new wxStaticText(gui, wxID_ANY, _("Scalar Field:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		m_ComboField_s = new wxComboBox(gui, ID_SCALARFIELD, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
		...
		bSizer_s2->Add(new wxStaticText(gui, wxID_ANY, _("Color by:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		m_ComboColorBy_s = new wxComboBox(gui, ID_SCALAR_COLOR_MAPPING_MODE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
	...
	if (nVectors > 0)
	{
		wxStaticBoxSizer* bSizerVector = new wxStaticBoxSizer(new wxStaticBox(gui, wxID_ANY, wxT("Vector fields")), wxVERTICAL);

		wxCheckBox* ckVectors = new wxCheckBox(gui, ID_ACTIVATE_VECTORS, _("Activate vector fields"), wxDefaultPosition, wxDefaultSize, 0);
		...
		bSizer1->Add(new wxStaticText(gui, wxID_ANY, _("Vector Field:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		m_ComboField_v = new wxComboBox(gui, ID_VECTORFIELD, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
		...
		bSizer2->Add(new wxStaticText(gui, wxID_ANY, _("Color by:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);

		m_ComboColorBy_v = new wxComboBox(gui, ID_VECTOR_COLOR_MAPPING_MODE, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
	...
	// VIEW PROPERTIES
	// ---------------
	wxStaticBoxSizer* bSizerProperties = new wxStaticBoxSizer(new wxStaticBox(gui, wxID_ANY, wxT("View properties")), wxVERTICAL);

	wxCheckBox* ckEnableMap = new wxCheckBox(gui, ID_ENABLE_MAP, _("Enable Color Mapping"), wxDefaultPosition, wxDefaultSize, 0);
	...
	bSizer3->Add(new wxStaticText(gui, wxID_ANY, _("LUT:")), 0, wxALL, 5);
	mafGUILutSwatch* luts2 = new mafGUILutSwatch(gui, ID_COLOR_MAPPING_LUT, wxDefaultPosition, wxSize(140, 18), wxTAB_TRAVERSAL | wxSIMPLE_BORDER);
	...
	wxCheckBox* chckShowSFLegend1 = new wxCheckBox(gui, ID_SHOW_COLOR_MAPPING, _("Show Color Mapping"), wxDefaultPosition, wxDefaultSize, 0);
	...
	wxCheckBox* ckShowSurface = new wxCheckBox(gui, ID_SHOW_SURFACE, _("Show Surface"), wxDefaultPosition, wxDefaultSize, 0);
	...
	wxCheckBox* ckShowGlyphs = new wxCheckBox(gui, ID_SHOW_GLYPHS, _("Show Glyphs"), wxDefaultPosition, wxDefaultSize, 0);
	...
	// GLYPH SHAPE
	// -----------
	wxStaticBoxSizer* sbSizer = new wxStaticBoxSizer(new wxStaticBox(gui, wxID_ANY, _("Glyph shape")), wxVERTICAL);

	sbSizer->Add(new wxStaticText(gui, wxID_ANY, _("Dimension"), wxDefaultPosition, wxDefaultSize, 0), 0, wxALL, 5);
	wxBoxSizer* bSizer4 = new wxBoxSizer(wxHORIZONTAL);
	wxTextCtrl* scale_text = new wxTextCtrl(gui, wxID_ANY, "", wxDefaultPosition, wxSize(30, 18), wxALL);
	mafGUIFloatSlider* slider = new mafGUIFloatSlider(gui, ID_SCALESLIDER, 0, 1, 10);
	...
	bSizer5->Add(new wxStaticText(gui, wxID_ANY, _("Radius:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);
	m_EdRadius = new wxTextCtrl(gui, ID_GLYPH_RADIUS);
	...
	bSizer51->Add(new wxStaticText(gui, wxID_ANY, _("Resolution:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);
	m_EdRes = new wxTextCtrl(gui, ID_GLYPH_RESOLUTION);
	...
	bSizer52->Add(new wxStaticText(gui, wxID_ANY, _("Length:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);
	m_EdLength = new wxTextCtrl(gui, ID_GLYPH_LENGTH);
	...
	bSizer53->Add(new wxStaticText(gui, wxID_ANY, _("Glyph Type:"), wxDefaultPosition, wxSize(60, -1), 0), 0, wxALL, 5);
	wxComboBox* comboGlyphs = new wxComboBox(gui, ID_GLYPH_TYPE, wxEmptyString, wxDefaultPosition, wxSize(60, -1), 0, NULL, wxCB_READONLY);
