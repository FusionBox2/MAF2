...
//----------------------------------------------------------------------------
{
	...
	gui->Enable(ID_DISTANCE_RANGE, meter_attrib->m_ColorMode == medVMEComputeWrapping::RANGE_COLOR);
	gui->Enable(ID_TUBE_RADIUS, meter_attrib->m_Representation == medVMEComputeWrapping::TUBE_REPRESENTATION);
	gui->Enable(ID_TUBE_CAPPING, meter_attrib->m_Representation == medVMEComputeWrapping::TUBE_REPRESENTATION);
	gui->Divider();
