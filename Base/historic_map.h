...
private:
  ...
  typedef std::unordered_map<key_type, storage_iterator>        index_type;
...
public:
  ...
  historic_map(historic_map&& hm) noexcept
  ...
  std::pair<iterator, bool> insert(const value_type& value)
  {
      ...
      auto addedIt = m_store.insert(m_store.end(), value);
      m_index[addedIt->first] = addedIt;
      return std::make_pair(addedIt, true);
  }
  ...
  std::pair<iterator, bool> insert(value_type&& value)
  {
    ...
    if (it != m_index.end())
      return std::make_pair(it->second, false);
    auto addedIt = m_store.insert(m_store.end(), std::move(value));
    m_index[addedIt->first] = addedIt;
    return std::make_pair(addedIt, true);
  }
