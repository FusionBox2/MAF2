...
MAF_EXPORT mafString mafGetOpenFile(const mafString& initial, const mafString& wildcard, const mafString& title = _R("Open File"), wxWindow* parent = nullptr);
...
{
	ID_VME_BEHAVIOR_UPDATE = EVT_USER_START + 900,
	MENU_FILE_SNAPSHOT,
	ID_GET_FILENAME,
	WIZARD_RUN_STARTING,
	WIZARD_RUN_CONTINUE,
...
{
	MENU_WIZARD = MENU_USER_START + 900,
	MED_MENU_USER_START,
};
