...
#ifndef __medPipeVolumeVR_BES_H__
#define __medPipeVolumeVR_BES_H__
...
// medPipeVolumeVR_BES :
//----------------------------------------------------------------------------
class medPipeVolumeVR_BES : public mafPipe
{
public:
  mafTypeMacro(medPipeVolumeVR_BES,mafPipe);

           medPipeVolumeVR_BES();
  virtual ~medPipeVolumeVR_BES();
...
#endif // __medPipeVolumeVR_BES_H__
