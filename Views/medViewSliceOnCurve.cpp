...
int medViewSliceOnCurve::GetNodeStatusI(mafNode *node)
//----------------------------------------------------------------------------
{
  if (((mafVME*)node)->GetOutput()->IsA("mafVMEOutputPolyline"))
  {
...
/*virtual*/ std::shared_ptr<mafPipe> medViewSliceOnCurve::GetNodePipeI(mafNode *vme)
//------------------------------------------------------------------------
{
...
/*virtual*/ void medViewSliceOnCurve::CreateGizmo(std::shared_ptr<mafNode> node)
//------------------------------------------------------------------------
{
  assert(m_Gizmo == NULL);
  if (m_Gizmo != NULL)    
