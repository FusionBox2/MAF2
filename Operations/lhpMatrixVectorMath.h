#ifndef __lhpMatrixVectorMath_h
#define __lhpMatrixVectorMath_h
...
//
// These methods are for vectors/matrices with dimension 3 or homogeneous with dimension 4.
// The default is non-homogeneous.
// Use SetHomogeneous() to set the homogeneous mode on or off.
// Some methods might assume that homogenous h = 1.
//
...
class lhpMatrixVectorMath{
public:
  // Constructor.
  lhpMatrixVectorMath(bool homogeneous = false) : m_homogeneous(homogeneous) {}
