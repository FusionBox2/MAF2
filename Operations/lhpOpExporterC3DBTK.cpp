/*=========================================================================
  ...
  Module:    $RCSfile: lhpOpExporterC3DBTK-BTK.cpp,v $
  Language:  C++
...
void lhpOpExporterC3DBTK::ExportOneCloud(btk::Acquisition::Pointer target, mafVMELandmarkCloud* cloud)
{
  ...
  {
    btk::Point::Pointer targetP = target->GetPoint(j);
...
void lhpOpExporterC3DBTK::ExportingTraverse(std::ostream &out, const char *dirName, mafNode* node)
{
  if(node->IsMAFType(mafVMELandmarkCloud))
  {
    /*if(dirName == NULL)
    ...
    else*/
    {
      ...
      fn += ".c3d";
      btk::Acquisition::Pointer target = btk::Acquisition::New();
      ExportOneCloud(target, mafVMELandmarkCloud::SafeDownCast(node));
      btk::AcquisitionFileWriter::Pointer writer = btk::AcquisitionFileWriter::New();
  ...
  //----------------------------------------------------------------------------
{
  ...
  {
    btk::Acquisition::Pointer target = btk::Acquisition::New();
    ExportOneCloud(target, mafVMELandmarkCloud::SafeDownCast(m_Input));
    btk::AcquisitionFileWriter::Pointer writer = btk::AcquisitionFileWriter::New();
...
//----------------------------------------------------------------------------
lhpOpExporterC3DBTK::_InternalC3DData::_InternalC3DData()
//----------------------------------------------------------------------------
{
  //vmes
  m_VmeGroup = NULL;
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::Clear()
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
int lhpOpExporterC3DBTK::OpenC3D(const mafString &fullFileName)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::Initialize(const mafString &fullFileName, lhpOpExporterC3DBTK::_InternalC3DData &intData)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
mafVMEGroup *lhpOpExporterC3DBTK::ImportSingleFile(const mafString &fullFileName, lhpOpExporterC3DBTK::_InternalC3DData &intData)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
bool lhpOpExporterC3DBTK::Import()
//----------------------------------------------------------------------------
{
  bool result = false;
  Clear();
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::ImportTrajectories(lhpOpExporterC3DBTK::_InternalC3DData &intData)
//----------------------------------------------------------------------------
{
  wxBusyInfo *wait;
  if(!m_TestMode)
  ...
  bool usingDictionary = false;//(m_DictionaryFileName != "");
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::ImportAnalog(lhpOpExporterC3DBTK::_InternalC3DData &intData)
//----------------------------------------------------------------------------
{
  wxBusyInfo *wait;
  if(!m_TestMode)
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::ImportPlatform(lhpOpExporterC3DBTK::_InternalC3DData &intData)
//----------------------------------------------------------------------------
{
  wxBusyInfo *wait;
  if(!m_TestMode)
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::ImportEvent(lhpOpExporterC3DBTK::_InternalC3DData &intData)
//----------------------------------------------------------------------------
{
  //For every event
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::CreateGui()
//----------------------------------------------------------------------------
{
	m_Gui = new mafGUI(this);
...
//----------------------------------------------------------------------------
void lhpOpExporterC3DBTK::OpUndo()
//----------------------------------------------------------------------------
{   
  for(unsigned i = 0; i < m_intData.size(); i++)
  {
