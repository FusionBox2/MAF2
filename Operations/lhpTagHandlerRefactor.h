...
=========================================================================*/
#ifndef __lhpTagHandlerRefactor_h
#define __lhpTagHandlerRefactor_h
...
class MAF_EXPORT lhpTagHandlerInputOutputParametersCargoRefactor : public mafObject
{
public:
  mafTypeMacro(lhpTagHandlerInputOutputParametersCargoRefactor, mafObject);
...
private:
  ...
  lhpTagHandlerInputOutputParametersCargoRefactor();

};

class MAF_EXPORT lhpTagHandlerRefactor : public mafObject
{
public:
  mafTypeMacro(lhpTagHandlerRefactor,mafObject);

  virtual void HandleAutoTag(lhpTagHandlerInputOutputParametersCargoRefactor *cargo){mafLogMessage("Please write handling code for this tag!");};  
