...
//----------------------------------------------------------------------------
{
  ...
  for (int i=0;i<size;i++)
  {
    ...
    if (!m_TestMode)
    {
      {mafEvent evUnq(this,PROGRESSBAR_SET_VALUE); evUnq.SetArg(((double) i)/((double) size)*25.); InvokeEvent(evUnq);}
    }
  }
  // ---------------------
  // MOMENT LEFT ---------
  ...
  for (int i=0;i<size;i++)
  {
    ...
    if (!m_TestMode)
    {
      {mafEvent evUnq(this,PROGRESSBAR_SET_VALUE); evUnq.SetArg(25+((double) i)/((double) size)*25.); InvokeEvent(evUnq);}
    }
  }  
  // ---------------------
  // FORCE RIGHT ---------
  ...
  for (int i=0;i<size;i++)
  {
    ...
    if (!m_TestMode)
    {
      {mafEvent evUnq(this,PROGRESSBAR_SET_VALUE); evUnq.SetArg(50+((double) i)/((double) size)*25.); InvokeEvent(evUnq);}
    }
  }
  // ---------------------
  // MOMENT RIGHT --------
  ...
  for (int i=0;i<size;i++)
  {
    ...
    if (!m_TestMode)
    {
      {mafEvent evUnq(this,PROGRESSBAR_SET_VALUE); evUnq.SetArg(75+((double) i)/((double) size)*25.); InvokeEvent(evUnq);}
    }
  }  
  ...
  if (!m_TestMode)
  {
    {mafEvent evUnq(this,PROGRESSBAR_SET_VALUE); evUnq.SetArg(0.0); InvokeEvent(evUnq);}
  }
  ...
  if (!f_Out.bad())
  {
    ...
    for (int i=0;i<size;i++)
    {
      ...
      if (!m_TestMode)
      {
        {mafEvent evUnq(this,PROGRESSBAR_SET_VALUE); evUnq.SetArg(((double) i)/((double) size)*100.); InvokeEvent(evUnq);}
      }
...
//----------------------------------------------------------------------------
{
  ...
  m_ForceLeft->Update();
  //m_ForceLeft->GetOutput()->GetOutputDataSet()->Update();
  m_MomentLeft->SetTimeStamp(kframes.at(0));
  m_MomentLeft->Update();
  //m_MomentLeft->GetOutput()->GetOutputDataSet()->Update();
  m_ForceRight->SetTimeStamp(kframes.at(0));
  m_ForceRight->Update();
  //m_ForceRight->GetOutput()->GetOutputDataSet()->Update();
  m_MomentRight->SetTimeStamp(kframes.at(0));
  m_MomentRight->Update();
  //m_MomentRight->GetOutput()->GetOutputDataSet()->Update();
  ...
  */
  ...
  else if (frame==1)
  {
    ...
    if (true)
    {
      ...
      vVME->Update();
      //vVME->GetOutput()->GetOutputDataSet()->Update();
