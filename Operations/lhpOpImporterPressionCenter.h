...
{
public:
	lhpOpImporterPressionCenter(const mafString& label = "PressionCenter Importer");
	~lhpOpImporterPressionCenter();
...
//  virtual void OnEvent(mafEventBase *maf_event);
  ...
  void SetPCFileName(const char *filepc){Clear(); m_PCInputFileNameFullPaths.resize(1);m_PCInputFileNameFullPaths[0] = filepc;}
  const char * GetPCFileName() {if(m_PCInputFileNameFullPaths.empty()) return NULL; return m_PCInputFileNameFullPaths[0];}
