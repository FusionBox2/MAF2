...
{  
  if (result==OP_RUN_OK)
  {
    {mafEvent evUnq(this,VME_SHOW); evUnq.SetVme(m_Sphere); InvokeEvent(evUnq);}
  ...
  { 
    ...
    {
      {mafEvent evUnq(this,VME_SHOW); evUnq.SetVme(m_ResampleInput); InvokeEvent(evUnq);}
      {mafEvent evUnq(this,VME_SELECT); evUnq.SetVme(m_ResampleInput); InvokeEvent(evUnq);}
