...
IMPLEMENT_APP(psLoaderPlusApp)

////BES: 14.5.2008 - OnIdle to unlock blocks
//BEGIN_EVENT_TABLE(psLoaderPlusApp, wxApp)
//  EVT_IDLE(psLoaderPlusApp::OnIdle)
//END_EVENT_TABLE()


//--------------------------------------------------------------------------------
bool psLoaderPlusApp::OnInit()
//--------------------------------------------------------------------------------
{
...
//void psLoaderPlusApp::OnIdle( wxIdleEvent &event )
//{ 
