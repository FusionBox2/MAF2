...
//BEGIN_EVENT_TABLE(BuilderApp, wxApp)
//  EVT_IDLE(BuilderApp::OnIdle)
//END_EVENT_TABLE()
...
mafPlugPipe<medPipeComputeWrapping>("Pipe to Visualize Compute Wrapping Meter");
  ...
  m_Logic->GetTopWin()->SetTitle("Builder");
  m_Logic->Configure();
 ...
 // m_Logic->Plug(new mmoEditMetadata("Metadata Editor"),"Modify");
  ...
  splashBitmap.LoadFile("../Splash/BuilderSplash.bmp", wxBITMAP_TYPE_BMP);
...
//void BuilderApp::OnIdle( wxIdleEvent &event )
//{ 
