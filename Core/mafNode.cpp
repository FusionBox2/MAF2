...
//-------------------------------------------------------------------------
{
  ...
  if(old_root != NULL)
  {
    if(new_root != old_root)
    {
      ...
      {mafEventBase evUnq(this, NODE_DETACHED_FROM_TREE); evUnq.SetChannel(MCH_DOWN); OnEvent(&evUnq);}
    }
  ...
  if(new_root != NULL)
  {
    ...
    if(new_root != old_root)
    {
      ...
      {mafEventBase evUnq(this, NODE_ATTACHED_TO_TREE); evUnq.SetChannel(MCH_DOWN); OnEvent(&evUnq);}
    }
  }
