...
/** mafVMEOutput - the output data structure of a VME node.
  ...
  */
class MAF_EXPORT mafVMEOutput : public mafObject, public mafObjectWithGUI, public core::WithProperties
{
public:
	mafVMEOutput();
	...
	virtual void GetBounds(mafOBB& bounds, mafTimeStamp t = -1) const;
	...
	virtual void GetVMEBounds(mafOBB& bounds, mafTimeStamp t = -1) const;
	...
	virtual void GetVMELocalBounds(mafOBB& bounds, mafTimeStamp t = -1) const;
...
protected:
	...
	mafVME* m_VME = nullptr;      ///< pointer to source VME
