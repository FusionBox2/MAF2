...
namespace io::parse
{
	...
	{
		return std::stoll(mafStringToStd(value.As<mafString>()));
	}
	uintmax_t Parse(const mafStorageElement& value, io::parse::To<uintmax_t>)
	{
		return std::stoull(mafStringToStd(value.As<mafString>()));
	}
	double Parse(const mafStorageElement& value, io::parse::To<double>)
	{
		return std::stod(mafStringToStd(value.As<mafString>()));
	}
}
...
//------------------------------------------------------------------------------
mafStorageElement::mafStorageElement(void* element, io::Reader* storage)
//------------------------------------------------------------------------------
{
	m_Storage = storage;
...
//------------------------------------------------------------------------------
mafStorageElement::mafStorageElement(void* const* elements, size_t numElems, io::Reader* storage)
//------------------------------------------------------------------------------
{
	m_Storage = storage;
	m_NumItems = numElems;
...
namespace io
{
	class ReaderImpl : XMLPlatformUtilsInitializer
	{
	public:
		ReaderImpl() {}
...
namespace io
{
	class WriterImpl : XMLPlatformUtilsInitializer
	{
	public:
		WriterImpl() {}
