...
namespace utilities
{
    namespace impl
    {
        ...
        public:
            template <class T>
            using DetectType = std::conditional_t<std::is_convertible_v<T, std::string_view>, std::string_view, T>;
    ...
    using DecayToStringView =
        std::conditional_t<std::is_same_v<T, std::string_view>, std::string_view, T>;
