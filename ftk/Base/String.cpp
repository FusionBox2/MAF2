...
mafString::mafString() = default;

mafString::mafString(mafStrBuf str)
	: m_str(str)
{
}
...
mafString mafString::substr(mafString::size_type pos, mafString::size_type count) const
{
	mafString result;
...
mafString::size_type mafString::find(mafStrBuf str) const
{
	...
	return (pos != std::basic_string<mafStringChar>::npos) ? pos : npos;
}
...
mafStrBuf mafString::c_str() const
{
#ifndef FUNCTIONAL_STRBUF
	return m_str.c_str();
#else
