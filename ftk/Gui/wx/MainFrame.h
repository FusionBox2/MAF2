...
public:
	...
	PaneFrame(const wxString& title, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = DefaultStyle, const wxString& name = wxASCII_STR(wxFrameNameStr));
...
template <class BaseFrame, long DefaultStyle>
PaneFrame<BaseFrame, DefaultStyle>::PaneFrame() = default;

template <class BaseFrame, long DefaultStyle>
PaneFrame<BaseFrame, DefaultStyle>::PaneFrame(const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name)
{
	Create(title, pos, size, style, name);
}

template <class BaseFrame, long DefaultStyle>
PaneFrame<BaseFrame, DefaultStyle>::~PaneFrame()
{
	mafSetFrame(nullptr);
}

template <class BaseFrame, long DefaultStyle>
bool PaneFrame<BaseFrame, DefaultStyle>::Create(const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name)
{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::CreateControls()
{
	CreateStatus();
}

template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::CreateStatus()
{
...
template <class BaseFrame, long DefaultStyle>
bool PaneFrame<BaseFrame, DefaultStyle>::AddPane(wxWindow* window, wxAuiPaneInfo& pane_info)
{
	...
	if (pane_info.IsToolbar())
	{
		...
		BaseFrame::Bind(wxEVT_MENU, &PaneFrame::OnSwitchPane, this, window->GetId(), window->GetId());
		BaseFrame::Bind(wxEVT_UPDATE_UI, &PaneFrame::OnUpdatePaneUI, this, window->GetId(), window->GetId());
	}
	else
	{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::OnSwitchPane(wxCommandEvent& event)
{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::OnUpdatePaneUI(wxUpdateUIEvent& event)
{
	wxAuiPaneInfoArray& all_panes = m_auiManager.GetAllPanes();
	size_t count = all_panes.GetCount();
	for (size_t i = 0; i < count; i++)
...
template <class BaseFrame, long DefaultStyle>
wxWindow* PaneFrame<BaseFrame, DefaultStyle>::RemovePane(const wxString& pane_name)
{
...
template <class BaseFrame, long DefaultStyle>
wxWindow* PaneFrame<BaseFrame, DefaultStyle>::RemovePane(wxWindow* window)
{
...
template <class BaseFrame, long DefaultStyle>
wxWindow* PaneFrame<BaseFrame, DefaultStyle>::RemovePane(wxAuiPaneInfo& pane_info)
{
	wxMenuBar* menubar = BaseFrame::GetMenuBar();
	int idx = menubar->FindMenu("View");
	if (idx != wxNOT_FOUND)
	{
		...
		if (pane_info.IsToolbar())
		{
			...
			BaseFrame::Unbind(wxEVT_MENU, &PaneFrame::OnSwitchPane, this, pane_info.window->GetId(), pane_info.window->GetId());
			BaseFrame::Unbind(wxEVT_UPDATE_UI, &PaneFrame::OnUpdatePaneUI, this, pane_info.window->GetId(), pane_info.window->GetId());
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ShowPane(const wxString& pane_name, bool show)
{
	wxAuiPaneInfo& pi = m_auiManager.GetPane(pane_name);
	if (pi.IsOk())
	{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ShowPane(wxWindow* window, bool show)
{
	ShowPane(m_auiManager.GetPane(window), show);
}

template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ShowPane(wxAuiPaneInfo& pane_info, bool show)
{
	if (pane_info.IsOk())
	{
		pane_info.Show(show);
...
template <class BaseFrame, long DefaultStyle>
bool PaneFrame<BaseFrame, DefaultStyle>::IsPaneShown(const wxString& pane_name)
{
	return IsPaneShown(m_auiManager.GetPane(pane_name));
}

template <class BaseFrame, long DefaultStyle>
bool PaneFrame<BaseFrame, DefaultStyle>::IsPaneShown(wxWindow* window)
{
	return IsPaneShown(m_auiManager.GetPane(window));
}

template <class BaseFrame, long DefaultStyle>
bool PaneFrame<BaseFrame, DefaultStyle>::IsPaneShown(const wxAuiPaneInfo& pane_info)
{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::Busy()
{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::Ready()
{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ProgressBarShow()
{
	if (m_PBCalls.empty())
	{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ProgressBarHide()
{
...
template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ProgressBarSetVal(int progress)
{
	if (!m_PBCalls.empty() && m_PBCalls.back() == m_ID_PBCall)
	{
...
template <class BaseFrame, long DefaultStyle>
int PaneFrame<BaseFrame, DefaultStyle>::ProgressBarGetStatus()
{
	return m_Gauge->GetValue();
}

template <class BaseFrame, long DefaultStyle>
void PaneFrame<BaseFrame, DefaultStyle>::ProgressBarSetText(const wxString& msg)
{
...
template <class BaseFrame, long DefaultStyle>
class MainFrame : public PaneFrame<BaseFrame, DefaultStyle>
{
public:
...
{
	if (!PaneFrame<BaseFrame, DefaultStyle>::Create(title, pos, size, style, name))
	{
		return false;
	}
