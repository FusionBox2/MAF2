/*=========================================================================
  ...
  Module:    $RCSfile: mafViewRXLHPBuilder.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __mafViewRXLHPBuilder_H__
#define __mafViewRXLHPBuilder_H__
...
\sa mafViewVTK
*/
class mafViewRXLHPBuilder: public mafViewRX
{
public:
  mafViewRXLHPBuilder(wxString label = "RX", int camera_position = CAMERA_RX_FRONT, bool show_axes = false, bool show_grid = false, bool show_ruler = false, int stereo = 0);
  virtual ~mafViewRXLHPBuilder(); 

  mafTypeMacro(mafViewRXLHPBuilder, mafViewRX);
  ...
  /** 
  Create the GUI on the bottom of the view. */
